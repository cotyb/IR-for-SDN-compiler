...
def draw_topo(topo):
    ...
    plt.figure()
    # nx.draw(topo, pos,c='b',with_labels=True)
...
def construct_sa():
    ...
    sa.add_edge_indirect(SA.Node(1),SA.Node(3)," srcip='192.168.1.1' && dstip='192.168.1.3' ",'FWD(25)','')
    sa.add_edge_indirect(SA.Node(1),SA.Node(2)," srcip='192.168.1.2' && dstip='192.168.1.3' ",'FWD(18)','')
